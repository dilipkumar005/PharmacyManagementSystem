...
public class ViewCustomer extends javax.swing.JFrame {
    ...
    public ViewCustomer(String tempUsername) {
        initComponents();
        username = tempUsername;
        setLocationRelativeTo(null);
        jTable1ComponentShown(null);
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Date of Birth", "Mobile Number", "Email Id", "Username", "Password", "Address"
            }
        ));
    ...
    private void jTable1ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jTable1ComponentShown
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM appuser where userRole = 'Customer'");
            while(rs.next()){
